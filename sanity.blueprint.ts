  ...
  resources: [
    defineDocumentFunction({
      ...
      event: {
        ...
        projection:
          '{_id, "mode": coalesce(mode, "splitG"), "fullPintUrl": fullPint.asset->url, "splitPintUrl": splitPint.asset->url, "hasFullVerdict": defined(fullPintVerdict), "hasSplitVerdict": defined(splitVerdict), "playerName": player->name, "geometry": localGeometry{split, score, lineInG, conf}}',
      },
    }),
  ],
})
